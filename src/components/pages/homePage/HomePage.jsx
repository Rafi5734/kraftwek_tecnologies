...
const HomePage = () => {
  return (
    <div className="">
      ...
      <div className="flex justify-between ms-3 me-3 mt-10">
        <div className="flex">
          <Tooltip
            ...
            // }}
          >
            <IconButton className="rounded-full bg-[#f35627]">
              <svg
                width="24px"
                height="24px"
                viewBox="0 0 32 32"
          ...
          <Tooltip content="Wish List">
            <IconButton className="rounded-full ms-5 me-3 bg-[#f35627]">
              <svg
        ...
        <div className="flex">
          <Tooltip content="Your Dashboard">
            <IconButton className="rounded-full bg-[#f35627] ms-3">
              <svg
                width="27px"
                height="27px"
                viewBox="0 0 24 24"
          ...
          <Tooltip content="Your cart">
            <IconButton className="rounded-full bg-[#f35627] ms-5">
              <svg
